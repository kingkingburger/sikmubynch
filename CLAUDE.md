...
project/                                # Godot 4 프로젝트
  project.godot                         # 엔진 설정
  autoloads/                            # 싱글톤 매니저 (GameManager)
  scenes/                               # 씬 파일 (.tscn)
    main/                               #   메인 게임 씬
    buildings/                          #   건물 씬 (HQ, Barricade)
    enemies/                            #   적 유닛 씬
...
M1 코어 루프 프로토타입 구현 완료. 7-마일스톤 로드맵 확정 (M1-M7).
- 요구사항 94개 결정 확정 (Clarify 4차)
- 설계/검증 문서 완성
- 구현 로드맵 Ouroboros 완료 (`docs/ouroboros/2026-03-20-impl-roadmap/`)
- Godot 4 프로젝트 생성 완료 — M1 코어 루프 (3D 이소메트릭, 건설, 적 스폰, 게임오버)
