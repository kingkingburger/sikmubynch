...
- 현재 상태: 건물 8종은 완료. **다시 만들 것 = `gun_tower.png`(아직 페인티드) + 몬스터 4종(`rusher` `tank` `splitter` `mini`, 귀여운 버전으로)** → `PROMPTS.md` A의 #1~#5.
...
| `rusher.png` | 38px 정사각 | 줌아웃에서 20px 이하. 둥글고 굵은 몸통, 큰 눈 |
| `tank.png` | 58px 정사각 | |
